  ...
  return (
    <div className="min-h-screen bg-[#0e0e0e] p-6 lg:p-10">
      <div className="max-w-lg">
        ...
        {/* Header */}
        <div className="mb-10">
          <p className="font-label text-[10px] uppercase tracking-[0.25em] text-white/30 mb-2">Mi Área</p>
          <h1 className="font-headline font-black text-4xl text-white tracking-tight">MI PERFIL</h1>
          <p className="text-white/40 text-sm mt-2 font-body">Tus datos personales y preferencias.</p>
        </div>
        ...
        <div className="space-y-8">
          ...
          <div>
            ...
            <p className="text-[11px] text-white/30 mt-1.5 font-label">
              Tu entrenador puede contactarte por este número.
            </p>
          </div>
